...
// Lowercases a string and strips everything but letters and digits.
const alnum = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, '');

// Builds a map of character bigram to occurrence count for a string.
...
// Sorensen-Dice coefficient over character bigrams, bounded 0..1 and tolerant of reordering.
...
// Splits a handle into meaningful sub-tokens across separators and camelCase boundaries.
...
// Scores a single address against the target handle and assigns a confidence tier.
